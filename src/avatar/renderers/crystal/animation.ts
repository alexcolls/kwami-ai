...
import type { CrystalAudioEffects } from './types'
...
/**
 * Animate crystal shards with orbital motion
 */
export function animateShards(
  shards: ShardState[],
  time: number,
  audioLevels: AudioLevels,
  effects: CrystalAudioEffects,
...
/**
 * Animate the entire crystal group
 */
export function animateCrystal(
  group: Group,
  shards: ShardState[],
  core: Mesh,
  glow: Mesh,
